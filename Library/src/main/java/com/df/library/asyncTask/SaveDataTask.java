...
public class SaveDataTask extends AsyncTask<JSONObject, Void, Boolean> {
     ...
     */
    public SaveDataTask(Context context, int carId, String path, List<PhotoEntity> photoEntityList, OnSaveDataFinished listener) {
    ...
    protected Boolean doInBackground(JSONObject... params) {
        ...
        try {
            ...
            OutputStreamWriter write = new OutputStreamWriter(
                    new FileOutputStream(path + Integer.toString(carId)), "UTF-8");
