    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.speech_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imm.hideSoftInputFromWindow(findViewById(R.id.comment).getWindowToken(), 0);

                SpeechDialog speechDialog = new SpeechDialog(AddPhotoCommentActivity.this, new SpeechDialog.OnResult() {
                    @Override
