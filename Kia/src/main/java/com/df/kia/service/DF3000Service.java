...
import com.df.library.service.filter.GaugeInfoFilter;
import com.df.library.service.filter.ProbeSerialNumberFilter;
import com.df.library.service.filter.TransmitValueFilter;
...
public class DF3000Service {
	...
	public static DF3000Service instance(UsbSerialDriver sDriver) {
		if (DF3000Service == null || com.df.kia.service.DF3000Service.sDriver == null) {
	...
	private DF3000Service(UsbSerialDriver sDriver) {
		com.df.kia.service.DF3000Service.sDriver = sDriver;
